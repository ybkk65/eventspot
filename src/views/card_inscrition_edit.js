...
export default (statut, id, mois, jour, titre, description, prix, categorie, nbr_pers, country_name, country_icone, pays, acces, majorite, image, nom , prenom, premiere_lettre,id_inscription) => {
  return (`
  ...
  <div>
      ...
      <button class="submitStatut" type="submit">Confirmer</button>
  </div>
</div>
